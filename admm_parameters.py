...
def _read_parameters_from_file(admm_params, params_data):
    admm_params.tol['consensus'] = float(params_data['tol']['consensus']['v'])
    admm_params.tol['consensus'] = float(params_data['tol']['consensus']['pf'])
    admm_params.tol['consensus'] = float(params_data['tol']['consensus']['ess'])
    admm_params.tol['stationarity'] = float(params_data['tol']['stationarity']['v'])
    admm_params.tol['stationarity'] = float(params_data['tol']['stationarity']['pf'])
    admm_params.tol['stationarity'] = float(params_data['tol']['stationarity']['ess'])
