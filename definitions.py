...
ESS_MODEL_EXACT = 1
ESS_MODEL_EXACT_SLACKED = 2
ESS_MODEL_BIGM = 3
ESS_MODEL_LP_SIMPLIFIED_EXTENDED = 4
ESS_MODEL_LP_RELAXED = 5
ESS_MODEL_FIRST_ORDER = 6
ESS_MODEL_PENALIZED = 7
...
PENALTY_ESS = 1e6
PENALTY_ESS_COMP = 1e6
PENALTY_ESS_BALANCE = 1e3
PENALTY_ESS_COMP_OBJECTIVE = 5
PENALTY_SHARED_ESS = 1e6
PENALTY_SHARED_ESS_COMP = 1e6
...
NODE_BALANCE_SLACK_LIMIT = 1e-3 # Node balance slacks' limit
...
ADMM_ADAPTIVE_PENALTY_FACTOR = 0.10
