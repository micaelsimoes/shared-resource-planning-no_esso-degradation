...
BRANCH_LIMIT_CURRENT_SIMPLIFIED = 2
BRANCH_LIMIT_APPARENT_POWER = 3
BRANCH_LIMIT_MIXED = 4
...
COST_GENERATION_CURTAILMENT = 10.00
...
PENALTY_ESS = 1e3
PENALTY_SHARED_ESS = 1e3
PENALTY_GENERATION_CURTAILMENT = 1e-2
