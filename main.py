...
def shared_resources_planning(working_directory, specification_filename):
    ...
    # planning_problem.run_operational_planning(type='distributed', print_results=True, debug_flag=True, filename=f'{planning_problem.name}_operational_planning_results_distributed_without ESS')
    planning_problem.run_operational_planning(type='distributed', candidate_solution=candidate_solution, print_results=True, debug_flag=True, filename=f'{planning_problem.name}_operational_planning_results_distributed_with ESS')
