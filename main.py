...
def shared_resources_planning(working_directory, specification_filename):
    ...
    candidate_solution = planning_problem.get_initial_candidate_solution()
    planning_problem.shared_ess_data.update_data_with_candidate_solution(candidate_solution['total_capacity'])
    esso_model = planning_problem.shared_ess_data.build_subproblem_decomposed()
    planning_problem.shared_ess_data.update_model_with_candidate_solution_decomposed(esso_model, candidate_solution['investment'])
    results = planning_problem.shared_ess_data.optimize_decomposed(esso_model)
    planning_problem.shared_ess_data.write_optimization_results_to_excel_decomposed(esso_model)
