...
def _run_smopf(network, model, params, from_warm_start=False):
    ...
    if params.solver_params.solver == 'ipopt':
        ...
        solver.options['compl_inf_tol'] = params.solver_params.solver_tol / network.baseMVA
        solver.options['acceptable_tol'] = params.solver_params.solver_tol / network.baseMVA
