...
def _build_model(network, params):
    ...
    if params.rg_curt:
        ...
        if params.slacks.generation.sg_abs:
            model.slack_sg_abs = pe.Var(model.generators, model.scenarios_market, model.scenarios_operation, model.periods, domain=pe.Reals, bounds=partial(sg_slack_bounds, network=network, params=params), initialize=0.0)
        ...
        if params.slacks.generation.sg_sqr:
            model.slack_sg_sqr = pe.Var(model.generators, model.scenarios_market, model.scenarios_operation, model.periods, domain=pe.Reals, bounds=partial(sg_sqr_slack_bounds, network=network, params=params), initialize=0.0)
        ...
        if params.slacks.generation.sg_curt:
            model.slack_sg_sqr = pe.Var(model.generators, model.scenarios_market, model.scenarios_operation, model.periods, domain=pe.Reals, bounds=partial(sg_slack_bounds, network=network, params=params), initialize=0.0)
    ...
    if params.rg_curt:
        ...
        model.sg_abs_def = pe.Constraint(model.generators, model.scenarios_market, model.scenarios_operation, model.periods, rule=partial(sg_abs_rule, network=network))
        model.sg_curt_def = pe.Constraint(model.generators, model.scenarios_market, model.scenarios_operation, model.periods, rule=partial(sg_curtailment_rule, network=network))
