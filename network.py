                    ...
                    for p in model.periods:
                        if generator.is_curtaillable():
                            ...
                            if generator.power_factor_control:
                                ...
                                model.generation_power_factor.add(model.qg[g, s_m, s_o, p] <= tan(max_phi) * model.pg[g, s_m, s_o, p] - SMALL_TOLERANCE)
                                model.generation_power_factor.add(model.qg[g, s_m, s_o, p] >= tan(min_phi) * model.pg[g, s_m, s_o, p] + SMALL_TOLERANCE)
                            else:
