...
def _get_initial_candidate_solution(planning_problem):
    ...
    for e in range(len(planning_problem.active_distribution_network_nodes)):
        ...
        for year in planning_problem.years:
            ...
            candidate_solution['investment'][node_id][year]['s'] = 0.50
            candidate_solution['investment'][node_id][year]['e'] = 0.50
            candidate_solution['total_capacity'][node_id][year] = dict()
            candidate_solution['total_capacity'][node_id][year]['s'] = 0.50
            candidate_solution['total_capacity'][node_id][year]['e'] = 0.50
