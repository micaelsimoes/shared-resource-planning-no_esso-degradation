...
def _run_operational_planning(planning_problem, candidate_solution, debug_flag=False):
    ...
    if debug_flag:
        for node_id in planning_problem.active_distribution_network_nodes:
            ...
            for year in consensus_vars['interface']['tso'][node_id]:
                print(f"\tYear {year}")
                for day in consensus_vars['interface']['tso'][node_id][year]:
                    print(f"\t\tDay {day}")
                    print(f"\t\t\tTSO, P  {consensus_vars['interface']['tso'][node_id][year][day]['p']}")
                    print(f"\t\t\tDSO, P  {consensus_vars['interface']['dso'][node_id][year][day]['p']}")
                    print(f"\t\t\tTSO, Q  {consensus_vars['interface']['tso'][node_id][year][day]['q']}")
                    print(f"\t\t\tDSO, Q  {consensus_vars['interface']['dso'][node_id][year][day]['q']}")
