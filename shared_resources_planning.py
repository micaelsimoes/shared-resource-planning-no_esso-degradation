                ...
                for s_m in tso_model[year][day].scenarios_market:
                    for s_o in tso_model[year][day].scenarios_operation:
                        for p in tso_model[year][day].periods:
                            ...
                            obj += 1e2 * (tso_model[year][day].expected_interface_vmag_sqr[dn, p] - vmag_sqr) ** 2
                            obj += 1e3 * (tso_model[year][day].expected_interface_pf_p[dn, p] - interface_pf_p) ** 2
                            obj += 1e3 * (tso_model[year][day].expected_interface_pf_q[dn, p] - interface_pf_q) ** 2
                            ...
                            obj += 1e3 * (tso_model[year][day].expected_shared_ess_p[dn, p] - interface_ess_p) ** 2
                            obj += 1e3 * (tso_model[year][day].expected_shared_ess_q[dn, p] - interface_ess_q) ** 2
                ...
                for s_m in dso_model[year][day].scenarios_market:
                    for s_o in dso_model[year][day].scenarios_operation:
                        for p in dso_model[year][day].periods:
                            ...
                            obj += 1e2 * (dso_model[year][day].expected_interface_vmag_sqr[p] - vmag_sqr) ** 2
                            obj += 1e3 * (dso_model[year][day].expected_interface_pf_p[p] - interface_pf_p) ** 2
                            obj += 1e3 * (dso_model[year][day].expected_interface_pf_q[p] - interface_pf_q) ** 2
                            ...
                            obj += 1e2 * (dso_model[year][day].expected_shared_ess_p[p] - interface_ess_p) ** 2
                            obj += 1e2 * (dso_model[year][day].expected_shared_ess_q[p] - interface_ess_q) ** 2
        ...
        for y in model.years:
            ...
            for d in model.days:
                ...
                for p in model.periods:
                    ...
                    dual_p_req_tso = dual_ess['esso']['current']['tso'][node_id][year][day]['p'][p]
