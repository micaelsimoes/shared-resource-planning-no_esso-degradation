        ...
        for e in model.energy_storages:
            ...
            for y in model.years:
                ...
                if sensitivities['s'][year][node_id] != 'N/A':
                    benders_cut += sensitivities['s'][year][node_id] * (model.s_rated[e, y] - candidate_solution['total_capacity'][node_id][year]['s'])
                if sensitivities['e'][year][node_id] != 'N/A':
                    benders_cut += sensitivities['e'][year][node_id] * (model.e_rated[e, y] - candidate_solution['total_capacity'][node_id][year]['e'])
