            ...
            for e in tso_model[year][day].shared_energy_storages:
                for p in tso_model[year][day].periods:
                    ...
                    if transmission_network.params.relax_equalities:
                        tso_model[year][day].interface_cons.add(tso_model[year][day].expected_shared_ess_p[p] <= expected_ess_p + EQUALITY_TOLERANCE)
                        tso_model[year][day].interface_cons.add(tso_model[year][day].expected_shared_ess_p[p] >= expected_ess_p - EQUALITY_TOLERANCE)
                        tso_model[year][day].interface_cons.add(tso_model[year][day].expected_shared_ess_q[p] <= expected_ess_q + EQUALITY_TOLERANCE)
                        tso_model[year][day].interface_cons.add(tso_model[year][day].expected_shared_ess_q[p] >= expected_ess_q - EQUALITY_TOLERANCE)
