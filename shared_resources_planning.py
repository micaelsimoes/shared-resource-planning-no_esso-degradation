...
def _run_operational_planning(planning_problem, candidate_solution, debug_flag=False):
    ...
    for iter in range(iter, admm_parameters.num_max_iters + 1):
        ...
        results['dso'] = update_distribution_coordination_models_and_solve(distribution_networks, dso_models,
                                                                           consensus_vars['interface']['v'], dual_vars['v']['dso'],
        ...
        results['tso'] = update_transmission_coordination_model_and_solve(transmission_network, tso_model,
                                                                          consensus_vars['interface']['v'], dual_vars['v']['tso'],
...
def create_admm_variables(planning_problem):
    ...
    for dn in range(len(planning_problem.active_distribution_network_nodes)):
        ...
        consensus_variables['interface']['v']['tso']['current'][node_id] = dict()
        consensus_variables['interface']['v']['dso']['current'][node_id] = dict()
        consensus_variables['interface']['v']['tso']['prev'][node_id] = dict()
        consensus_variables['interface']['v']['dso']['prev'][node_id] = dict()
        ...
        dual_variables['v']['tso'][node_id] = dict()
        ...
        for year in planning_problem.years:
            ...
            consensus_variables['interface']['v']['tso']['current'][node_id][year] = dict()
            consensus_variables['interface']['v']['tso']['prev'][node_id][year] = dict()
            consensus_variables['interface']['v']['dso']['current'][node_id][year] = dict()
            consensus_variables['interface']['v']['dso']['prev'][node_id][year] = dict()
            ...
            dual_variables['v']['tso'][node_id][year] = dict()
            ...
            for day in planning_problem.days:
                ...
                consensus_variables['interface']['v']['tso']['current'][node_id][year][day] = [node_base_kv] * num_instants
                consensus_variables['interface']['v']['dso']['current'][node_id][year][day] = [node_base_kv] * num_instants
                ...
                consensus_variables['interface']['v']['tso']['prev'][node_id][year][day] = [node_base_kv] * num_instants
                consensus_variables['interface']['v']['dso']['prev'][node_id][year][day] = [node_base_kv] * num_instants
                ...
                dual_variables['v']['tso'][node_id][year][day] = [0.0] * planning_problem.num_instants
        ...
        for day in transmission_network.days:
            ...
            for e in model[year][day].shared_energy_storages:
                ...
                for p in model[year][day].periods:
                    ...
                    obj += (model[year][day].dual_ess_p_req[e, p] * s_base) * constraint_ess_p
                    obj += (model[year][day].dual_ess_q_req[e, p] * s_base) * constraint_ess_q
                    obj += (model[year][day].rho_ess * s_base / 2) * constraint_ess_p ** 2
                    obj += (model[year][day].rho_ess * s_base / 2) * constraint_ess_q ** 2
        ...
        for year in distribution_network.years:
            for day in distribution_network.days:
                ...
                for p in dso_model[year][day].periods:
                    ...
                    obj += (dso_model[year][day].dual_pf_p_req[p] * s_base) * constraint_p_req
                    obj += (dso_model[year][day].dual_pf_q_req[p] * s_base) * constraint_q_req
                    obj += (dso_model[year][day].rho_pf  * s_base / 2) * (constraint_p_req ** 2)
                    obj += (dso_model[year][day].rho_pf  * s_base / 2) * (constraint_q_req ** 2)
                    ...
                    obj += (dso_model[year][day].dual_ess_p_req[p] * s_base) * constraint_ess_p_req
                    obj += (dso_model[year][day].dual_ess_q_req[p] * s_base) * constraint_ess_q_req
                    obj += (dso_model[year][day].rho_ess * s_base / 2) * constraint_ess_p_req ** 2
                    obj += (dso_model[year][day].rho_ess * s_base / 2) * constraint_ess_q_req ** 2
...
def check_stationary_convergence(planning_problem, consensus_vars, params):
    ...
    for node_id in planning_problem.distribution_networks:
        ...
        for year in planning_problem.years:
            for day in planning_problem.days:
                for p in range(planning_problem.num_instants):
                    sum_sqr_error_vmag += rho_tso_v * (consensus_vars['interface']['v']['tso']['current'][node_id][year][day][p] - consensus_vars['interface']['v']['tso']['prev'][node_id][year][day][p]) ** 2
                    sum_sqr_error_vmag += rho_dso_v * (consensus_vars['interface']['v']['dso']['current'][node_id][year][day][p] - consensus_vars['interface']['v']['dso']['prev'][node_id][year][day][p]) ** 2
                    num_elems_vmag += 2

                    sum_sqr_error_pf += rho_tso_pf * (consensus_vars['interface']['pf']['tso']['current'][node_id][year][day]['p'][p] - consensus_vars['interface']['pf']['tso']['prev'][node_id][year][day]['p'][p]) ** 2
                    sum_sqr_error_pf += rho_tso_pf * (consensus_vars['interface']['pf']['tso']['current'][node_id][year][day]['q'][p] - consensus_vars['interface']['pf']['tso']['prev'][node_id][year][day]['q'][p]) ** 2
                    sum_sqr_error_pf += rho_dso_pf * (consensus_vars['interface']['pf']['dso']['current'][node_id][year][day]['p'][p] - consensus_vars['interface']['pf']['dso']['prev'][node_id][year][day]['p'][p]) ** 2
                    sum_sqr_error_pf += rho_dso_pf * (consensus_vars['interface']['pf']['dso']['current'][node_id][year][day]['q'][p] - consensus_vars['interface']['pf']['dso']['prev'][node_id][year][day]['q'][p]) ** 2
                    num_elems_pf += 4

                    sum_sqr_error_ess += rho_tso_ess * (consensus_vars['ess']['tso']['current'][node_id][year][day]['p'][p] - consensus_vars['ess']['tso']['prev'][node_id][year][day]['p'][p]) ** 2
                    sum_sqr_error_ess += rho_tso_ess * (consensus_vars['ess']['tso']['current'][node_id][year][day]['q'][p] - consensus_vars['ess']['tso']['prev'][node_id][year][day]['q'][p]) ** 2
                    sum_sqr_error_ess += rho_dso_ess * (consensus_vars['ess']['dso']['current'][node_id][year][day]['p'][p] - consensus_vars['ess']['dso']['prev'][node_id][year][day]['p'][p]) ** 2
                    sum_sqr_error_ess += rho_dso_ess * (consensus_vars['ess']['dso']['current'][node_id][year][day]['q'][p] - consensus_vars['ess']['dso']['prev'][node_id][year][day]['q'][p]) ** 2
                    num_elems_ess += 4
