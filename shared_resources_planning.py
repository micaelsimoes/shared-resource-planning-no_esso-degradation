...
def create_transmission_network_model(transmission_network, consensus_vars, candidate_solution):
    ...
    for year in transmission_network.years:
        for day in transmission_network.days:
            ...
            # Free P, Q of shared ESSs
            for e in tso_model[year][day].shared_energy_storages:
                s_max = transmission_network.network[year][day].shared_energy_storages[e].s / s_base
                for s_m in tso_model[year][day].scenarios_market:
                    for s_o in tso_model[year][day].scenarios_operation:
                        for p in tso_model[year][day].periods:
                            tso_model[year][day].shared_es_pnet[e, s_m, s_o, p].setub(s_max + EQUALITY_TOLERANCE)
                            tso_model[year][day].shared_es_pnet[e, s_m, s_o, p].setlb(-s_max - EQUALITY_TOLERANCE)
                            tso_model[year][day].shared_es_qnet[e, s_m, s_o, p].setub(s_max + EQUALITY_TOLERANCE)
                            tso_model[year][day].shared_es_qnet[e, s_m, s_o, p].setlb(-s_max - EQUALITY_TOLERANCE)
            ...
            for dn in tso_model[year][day].active_distribution_networks:
                ...
                for p in tso_model[year][day].periods:
                    ...
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_vmag_sqr[dn, p] <= expected_vmag_sqr + VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_vmag_sqr[dn, p] >= expected_vmag_sqr - VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_pf_p[dn, p] <= expected_pf_p + VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_pf_p[dn, p] >= expected_pf_p - VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_pf_q[dn, p] <= expected_pf_q + VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_interface_pf_q[dn, p] >= expected_pf_q - VIOLATION_TOLERANCE * (1 / s_base))
            for e in tso_model[year][day].shared_energy_storages:
                for p in tso_model[year][day].periods:
                    expected_ess_p = 0.00
                    ...
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_shared_ess_p[e, p] <= expected_ess_p + VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_shared_ess_p[e, p] >= expected_ess_p - VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_shared_ess_q[e, p] <= expected_ess_q + VIOLATION_TOLERANCE * (1 / s_base))
                    tso_model[year][day].interface_expected_values.add(tso_model[year][day].expected_shared_ess_q[e, p] >= expected_ess_q - VIOLATION_TOLERANCE * (1 / s_base))
        ...
        for day in transmission_network.days:
            for dn in tso_model[year][day].active_distribution_networks:
                ...
                for p in tso_model[year][day].periods:
                    ...
                    tso_model[year][day].expected_interface_vmag_sqr[dn, p].fix(interface_vmag_sqr)
        ...
        for year in distribution_network.years:
            for day in distribution_network.days:
                ...
                for p in dso_model[year][day].periods:
                    ...
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_vmag_sqr[p] <= expected_vmag_sqr + VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_vmag_sqr[p] >= expected_vmag_sqr - VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_p[p] <= expected_pf_p + VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_p[p] >= expected_pf_p - VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_q[p] <= expected_pf_q + VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_q[p] >= expected_pf_q - VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_p[p] <= expected_ess_p + VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_p[p] >= expected_ess_p - VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_q[p] <= expected_ess_q + VIOLATION_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_q[p] >= expected_ess_q - VIOLATION_TOLERANCE * (1 / s_base))
        ...
        for day in transmission_network.days:
            ...
            for dn in model[year][day].active_distribution_networks:
                ...
                for p in model[year][day].periods:
                    ...
                    model[year][day].expected_shared_ess_p[shared_ess_idx, p].fixed = False
                    model[year][day].expected_shared_ess_q[shared_ess_idx, p].fixed = False
                ...
                for s_m in dso_model[year][day].scenarios_market:
                    for s_o in dso_model[year][day].scenarios_operation:
                        for p in dso_model[year][day].periods:
                            ...
                            dso_model[year][day].f[ref_node_idx, s_m, s_o, p].fix(0.00)
                            ...
                            if distribution_network.params.rg_curt:
                                ...
                                dso_model[year][day].qg_curt_down[ref_gen_idx, s_m, s_o, p].setub(EQUALITY_TOLERANCE)
                                dso_model[year][day].qg_curt_up[ref_gen_idx, s_m, s_o, p].setub(EQUALITY_TOLERANCE)
                ...
                for p in dso_model[year][day].periods:
                    ...
                    for s_m in dso_model[year][day].scenarios_market:
                        ...
                        for s_o in dso_model[year][day].scenarios_operation:
                            ...
                            expected_ess_p += omega_market * omega_oper * dso_model[year][day].shared_es_pnet[shared_ess_idx, s_m, s_o, p]
                            expected_ess_q += omega_market * omega_oper * dso_model[year][day].shared_es_qnet[shared_ess_idx, s_m, s_o, p]
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_vmag_sqr[p] <= expected_vmag_sqr + SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_vmag_sqr[p] >= expected_vmag_sqr - SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_p[p] <= expected_pf_p + SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_p[p] >= expected_pf_p - SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_q[p] <= expected_pf_q + SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_interface_pf_q[p] >= expected_pf_q - SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_p[p] <= expected_ess_p + SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_p[p] >= expected_ess_p - SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_q[p] <= expected_ess_q + SMALL_TOLERANCE * (1 / s_base))
                    dso_model[year][day].interface_expected_values.add(dso_model[year][day].expected_shared_ess_q[p] >= expected_ess_q - SMALL_TOLERANCE * (1 / s_base))
