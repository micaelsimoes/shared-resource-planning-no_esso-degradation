...
def net_load_per_node_rule(model, i, s_m, s_o, p, network, params):
    Pd, Qd = compute_node_load(model, i, s_m, s_o, p, network, params)
    return (model.pc_node[i, s_m, s_o, p] == Pd, model.qc_node[i, s_m, s_o, p] == Qd)


def net_gen_per_node_rule(model, i, s_m, s_o, p, network, params):
    Pg, Qg = compute_node_load(model, i, s_m, s_o, p, network, params)
    return (model.pg_node[i, s_m, s_o, p] == Pg, model.qg_node[i, s_m, s_o, p] == Qg)
