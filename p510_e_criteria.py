"""
Stage P5.10-E -- convergence criterion audit on the stabilized oracle.
...
import p510_oracle as EV  # noqa: E402

OUT_PATH = os.path.join(EV.OUT_DIR, 'p510_e_criteria.json')
SOURCES = ('p510_a_state.json', 'p510_b_fixedrho_pf300.json',
...
def main():
    ...
    if not cycles:
        print('[P5.10-E] no per-cycle evidence found; run A/B/D first.')
        sys.exit(1)
    ...
    print('[P5.10-E] convergence criterion audit')
