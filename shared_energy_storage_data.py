...
def _build_subproblem_model(shared_ess_data):
    ...
    model.es_penalty_snet_down = pe.Var(model.energy_storages, model.years, model.days, model.periods, domain=pe.NonNegativeReals, initialize=0.0)
        ...
        for y in model.years:
            for d in model.days:
                for p in model.periods:
                    ...
                    model.energy_storage_operation_agg.add(model.es_snet[e, y, d, p] == agg_snet + model.es_penalty_snet_up[e, y, d, p] - model.es_penalty_snet_down[e, y, d, p])
